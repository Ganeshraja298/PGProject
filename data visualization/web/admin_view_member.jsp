   ...
   <body>
                     ...
                     <div class="custom_menu">
                        <ul>
                           <li><a href="admin_home.jsp">Home</a></li>
                            ...
                            <li><a href="admin_view_member.jsp"style="color: yellow">View Member</a></li>
      ...
      <form action="" method="post" name="form1" id="form1" >
                        ...
                        <table width="90%" border="0" align="center">
                             <tr>
                                 <td height="53" colspan="9"><div align="center" class="style1 style3">  <h1 style="color:#e6b800;"> Customer details: </h1></div></td></h1>
                            </tr>
                             <tr>
                             ...
                             <td width="91"><h4 align="center" class="style8 style2">Contact </h4></td>
                              ...
                              <td width="91"><h4 align="center" class="style8 style2">Member Code</h4></td>
                             ...
                             <%       
                                ...
                                ResultSet rs0 = stmt3.executeQuery("select * from membership where status='1' ");
                                int s = 0;
                                while (rs0.next()) {
                                    if (s == 0) {
                            %>
