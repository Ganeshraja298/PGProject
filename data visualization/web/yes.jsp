...
try
{
  ...
  if(btn.equals("Submit"))
  {
      ...
      String n="select * from membership where mcode='"+name+"' && pass='"+pass+"' && status='1' ";
...
<html lang="en">
                     ...
                     <div class="custom_menu">
                        <ul>
                           <li><a href="user_home.jsp">Home</a></li>
                            <li><a href="m_login.jsp">Membership Login</a></li>
  ...
  <tr>
      <td height="53" colspan="4"><div align="center" class="style1 style3">  <h1 style="color:#e6b800;">Member Login : </h1></div></td></h1>
   </tr>
  <tr>
    <td width="20%" height="61">&nbsp;</td>
    <td width="30%"><div align="center" class="style2"><h2>Membership Code : </h2> </div></td>
