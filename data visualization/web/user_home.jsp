    ...
    <body>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="custom_menu">
                                <ul>
                                    <li><a href="user_home.jsp"style="color:yellow">Home</a></li>
                ...
                <div class="container">
                    <div class="containt_main">
                        <div id="mySidenav" class="sidenav">
                            ...
                            <a href="user_view_pro.jsp">View Product</a>
                            <a href="user_view_cart.jsp">View Cart</a>
                     ...
                     <div class="carousel-item active">
                        <div class="row">
                           <div class="col-sm-12">
                              ...
                              <div class="buynow_bt"><a href="yes.jsp">Get Now</a></div>
                           </div>
                        </div>
                     </div>
        ...
        <!-- banner bg main end -->
          ...
          <form action="" method="post" name="form1" id="form1" >
            <p>&nbsp;</p>
            <h3 align="center"><span class="style2 style1"><span class="bold style1 style3">Product Details </span></span></h3>

            <%           ResultSet rs0 = stmt3.executeQuery("select * from product ");
                int s = 0;
                while (rs0.next()) {
                    if (s == 0) {
            %>
