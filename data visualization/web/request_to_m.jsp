        ...
        if (btn.equals("Submit")) {
            ...
            if (contact.matches("^[0-9]*$") && contact.length() == 10) {
                if (email.matches(Email)) {
                    String qry = "select max(id) as maxid from membership";
                    ...
                    String ins = "insert into membership values('" + id2 + "','" + uid + "','" + name + "','" + contact + "','" + email + "','" + genter + "','" + address + "','','" + password + "','0')";
                    int n = stmt.executeUpdate(ins);
                    if (n == 1) {
%>
<script language="javascript">
    alert("Request Sended Successfully");
    window.location.href = "request_to_m.jsp";
</script>
<%
} else {
%>
                        ...
                        <div class="col-sm-12">
                            <div class="custom_menu">
                                <ul>
                                    ...
                                    <li><a href="request_to_m.jsp"style="color: yellow">Request TO Membership</a></li>
