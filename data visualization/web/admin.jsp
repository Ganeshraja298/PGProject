...
try
{
  ...
  if(btn.equals("Submit"))
  {
      ...
      String n="select * from admin where uname='"+name+"' && pass='"+pass+"'";
...
<html lang="en">
                  ...
                  <div class="col-sm-12">
                     <div class="custom_menu">
                        <ul>
                           ...
                           <li><a href="admin.jsp"style="color: yellow">Admin</a></li>
  ...
  <tr>
      <td height="53" colspan="4"><div align="center" class="style1 style3">  <h1 style="color:#e6b800;">Admin Login : </h1></div></td></h1>
   </tr>
  <tr>
